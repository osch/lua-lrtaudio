...
#elif defined(LRTAUDIO_ASYNC_USE_STDATOMIC)
typedef atomic_int      AtomicCounter;
typedef atomic_intptr_t AtomicPtr;
#elif defined(LRTAUDIO_ASYNC_USE_GNU)
...
#elif defined(LRTAUDIO_ASYNC_USE_WINTHREAD)
typedef DWORD ThreadId;
#elif defined (LRTAUDIO_ASYNC_USE_STDTHREAD)
...
#define async_lock_init lrtaudio_async_lock_init
void async_lock_init(Lock* lock);

/* -------------------------------------------------------------------------------------------- */

#define async_lock_destruct lrtaudio_async_lock_destruct
...
#define async_mutex_init lrtaudio_async_mutex_init
void async_mutex_init(Mutex* mutex);

/* -------------------------------------------------------------------------------------------- */

#define async_mutex_destruct lrtaudio_async_mutex_destruct
...
#define async_mutex_wait lrtaudio_async_mutex_wait
void async_mutex_wait(Mutex* mutex);

/* -------------------------------------------------------------------------------------------- */

#define async_mutex_wait_millis lrtaudio_async_mutex_wait_millis
