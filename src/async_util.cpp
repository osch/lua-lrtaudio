...
void lrtaudio_async_lock_init(Lock* lock)
{
...
void lrtaudio_async_lock_destruct(Lock* lock)
{
#if defined(LRTAUDIO_ASYNC_USE_PTHREAD)
...
void lrtaudio_async_mutex_init(Mutex* mutex)
{
#if defined(LRTAUDIO_ASYNC_USE_PTHREAD)
...
void lrtaudio_async_mutex_destruct(Mutex* mutex)
{
#if defined(LRTAUDIO_ASYNC_USE_PTHREAD)
...
void lrtaudio_async_mutex_wait(Mutex* mutex) 
{
#if defined(LRTAUDIO_ASYNC_USE_PTHREAD)
...
bool lrtaudio_async_mutex_wait_millis(Mutex* mutex, int timeoutMillis)
{
#if defined(LRTAUDIO_ASYNC_USE_PTHREAD)
